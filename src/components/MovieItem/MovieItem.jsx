...
export const MovieItem = ({ item, status, onChangeRating }) => {
  ...
  return (
    <div className="movie-list-item">
      <Card
        hoverable
        className="movie-list-item__card"
        cover={
          <Image
            width={183}
            height={281}
            src={status === 'loading-cards' ? null : picture}
            alt={status !== 'loading-cards' ? title : 'loading'}
      ...
      >
        <div className="movie-list-item__wrapper">
          <div className="movie-list-item__main">
            <div className="movie-list-item__main-wrapper">
              <div className="movie-list-item__main-image">
                <Image
                  width={60}
                  height={91}
                  src={status === 'loading-cards' ? null : picture}
              ...
              <div className="movie-list-item__main-header">
                ...
                <div className="movie-list-item__genres">
                  <GenreConsumer>{(genresList) => <GenreList genres={genres} genresList={genresList} />}</GenreConsumer>
                </div>
              </div>
            </div>
          ...
          <div className="movie-list-item__user-rating">
            <ClientRating id={id} clientRating={clientRating} onChangeRating={onChangeRating} />
          </div>
        </div>
      </Card>
    </div>
